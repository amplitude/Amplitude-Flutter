...
class AmplitudeWeb extends _Amplitude {
  static Map<String, AmplitudeWeb>? _instances;

  final String _instanceName = '\$default_instance';

  static AmplitudeWeb getInstance(
      {String instanceName = '\$default_instance'}) {
    if (_instances == null) {
      _instances = <String, AmplitudeWeb>{};
    }

    return _instances!.putIfAbsent(instanceName, () => new AmplitudeWeb());
  }
