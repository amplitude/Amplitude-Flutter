...
class Amplitude extends _Amplitude {
  ...
  Amplitude._(this.configuration);

  Future<void> _init() async {
    await _channel.invokeListMethod(
        "init", jsonEncode(this.configuration.toMap()));
  }

  /// Returns an Amplitude instance
  ///
  /// Wait until Amplitude instances are initialized on all platforms (Android, iOS, and Web)
  ///
  /// ```
  /// var amplitude = await Amplitude.init(Configuration(apiKey: "apiKey"));
  /// ```
  static Future<Amplitude> init(Configuration configuration, [MethodChannel? methodChannel]) async {
    final amplitude = Amplitude._(configuration);
    amplitude._channel = methodChannel ?? amplitude._channel;
    await amplitude._init();
    return amplitude;
  }
  ...
  Future<void> identify(
    ...
    return await _channel.invokeMethod("identify", jsonEncode(event.toMap()));
  }
  ...
  Future<void> groupIdentify(
    ...
    return await _channel.invokeMethod(
        "groupIdentify", jsonEncode(event.toMap()));
  }
  ...
  Future<void> setGroup(
    ...
    return await _channel.invokeMethod("setGroup", jsonEncode(event.toMap()));
  }
  ...
  Future<void> revenue({
    ...
    return await _channel.invokeMethod("revenue", jsonEncode(event.toMap()));
  }
  ...
  Future<void> setDeviceId(String deviceId) async {
    ...
    await await _channel.invokeMethod("setDeviceId", jsonEncode(properties));
  }
